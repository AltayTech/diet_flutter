...
const double _kOffset = 60.0; // distance to bottom of banner, at a 45 degree angle inwards
const double _kHeight = 30.0; // height of banner
...
class BannerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _textPainter.paint(canvas, _kRect.topLeft + Offset(0.0, (_kRect.height - _textPainter.height)));
  }
