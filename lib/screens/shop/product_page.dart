                                ...
                                return Column(
                                  children: [
                                    firstSection(
                                        ...
                                        snapshot.data!.productThambnail,
                                        snapshot.data!.sellingPrice,
                                        snapshot.data!.discountPrice,
                                        snapshot.data!.userOrderDate),
                                    secondSection(snapshot.data!.shortDescription,
                                        snapshot.data!.longDescription, snapshot.data!.iconState),
                                  ],
                                );
                              });
                        else
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(15.0)),
                          child: Center(
                            child: ImageUtils.fromLocal(stateIcon!,
