                ...
                children: [
                  Row(
                    children: [
                      ...
                      ImageUtils.fromLocal('assets/images/bill/alert.svg',
                  ...
                  Container(
                    decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(15.0), color: AppColors.grey),
                    child: Padding(
                      padding: const EdgeInsets.all(12.0),
                      child: Column(
                        children: [
                  ...
                  Row(
                    ...
                    children: [
                      ImageUtils.fromLocal('assets/images/foodlist/advice/bulb.svg',
                          width: 2.w, height: 2.h, color: AppColors.redBar),
                      Flexible(
                          child: Text(intl.rulesConfirm,
                              style: TextStyle(fontSize: 10.sp, color: AppColors.redBar))),
                    ],
                  ),
                  Space(height: 2.h),
                  button(
                      ...
                      () => VxNavigator.of(context)
                          .push(Uri.parse(Routes.psychologyPaymentBill), params: args)),
                ],
              ),
            ),
          ),
    ...
    return Row(
      ...
      children: [
        ...
        Flexible(
            child: Text(txt,
                style: TextStyle(
                    fontSize: 14.sp, fontWeight: FontWeight.w800, color: AppColors.penColor))),
      ],
    );
  }
