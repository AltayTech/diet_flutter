...
class _PsychologyIntroScreenState
    extends ResourcefulState<PsychologyIntroScreen> {
      ...
      if (event != null) {
        if (event)
          VxNavigator.of(context)
              .push(Uri.parse(Routes.psychologyReservedMeeting));
        else
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: Container(
            ...
            height: 10.h,
            child: Center(
                child: Text(intl.sessionReserve,
