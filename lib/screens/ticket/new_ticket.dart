...
import 'package:behandam/extensions/color.dart';
                              ...
                              return ShaderMask(
                                ...
                                child: ListView.builder(
                                  itemBuilder: (context, index) {
                                    return supportTypeItem(bloc.SupportItems[index]);
                                  },
                                  shrinkWrap: true,
                                  reverse: false,
                                  itemCount: bloc.SupportItems.length,
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    fill="white" />
                        ...
                        """
                                .replaceAll('#1ABC9C', AppColors.primary.toHex()),
                            width: 3.w,
                            height: 3.h,
                          )
