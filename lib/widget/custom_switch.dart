...
class CustomSwitch extends StatefulWidget {
  ...
  @override
  _CustomSwitch createState() => _CustomSwitch(this.isSwitched,this.title,this.lableLeft,this.lableRight,this.colorSelected,this.colorOff,this.function);
}
    ...
    return Container(
      ...
      isSwitched ? Expanded(
              ...
              child: Text(lableLeft!,
                  ...
                  style: typography.caption!.copyWith(color: colorSelected)),
            ) : Container(),
            Expanded(
              flex: 0,
              child: Directionality(
                ...
                child: Switch(
                  ...
                  // activeThumbImage: AssetImage("assets/ellipse.png"),
